...
class AttendanceStatistics(BaseModel):
    ...
    module_breakdown: Dict[str, float]  # module_id -> attendance_rate
    specialty_breakdown: Dict[str, float]  # specialty_id -> attendance_rate
...
class StudentStatistics(BaseModel):
    ...
    exclusion_status: Dict[str, bool]  # module_id -> is_excluded
