...
class AttendanceController:
    ...
    def update_attendance_status(
        ...
        valid_transitions = {
            AttendanceStatus.ABSENT: [AttendanceStatus.PRESENT, AttendanceStatus.JUSTIFIED, AttendanceStatus.EXCLUDED],
            AttendanceStatus.PRESENT: [AttendanceStatus.ABSENT],  # Can undo mark
            AttendanceStatus.JUSTIFIED: [AttendanceStatus.ABSENT],  # Can reject justification
