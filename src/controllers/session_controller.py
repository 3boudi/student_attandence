...
class SessionController(BaseController[ClassSession, SessionCreate, SessionUpdate]):
    ...
    def get_session_with_details(self, db: Session, session_id: str) -> Optional[ClassSession]:
    ...
    def get_sessions_by_module(self, db: Session, module_id: str, 
    ...
    def get_sessions_by_teacher(self, db: Session, teacher_id: str,
    ...
    def get_todays_sessions(self, db: Session, teacher_id: Optional[str] = None) -> List[ClassSession]:
    ...
    def get_session_attendance_summary(self, db: Session, session_id: str) -> Dict[str, Any]:
